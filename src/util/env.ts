...
const defaultEnvValues = {
  ...
  CORE_RPC:
    "https://rpc.coredao.org,https://rpc.ankr.com/core,https://1rpc.io/core,https://rpc-core.icecreamswap.com",
  BITGERT_RPC:
    "https://flux-rpc2.brisescan.com,https://mainnet-rpc.brisescan.com,https://chainrpc.com,https://serverrpc.com,https://flux-rpc.brisescan.com",
  BITCHAIN_RPC: "https://rpc.bitchain.biz/",
  OZONE_RPC: "https://node1.ozonechain.io",
  ZETA_RPC:
    "https://zetachain-evm.blockpi.network/v1/rpc/public,https://zetachain-mainnet-archive.allthatnode.com:8545",
...
const _ENV_CONSTANTS = {
  ...
  DEBUG_LEVEL2:
    process.env.LLAMA_DEBUG_LEVEL2 || process.env.LLAMA_SDK_DEBUG_LEVEL_3
      ? "true"
      : "false",
  DEBUG_LEBEL_3: isDebugLevel3,
  LOG_LLAMA_PROVIDER_CALLS:
    isDebugLevel3 || process.env.LLAMA_SDK_LOG_LLAMA_PROVIDER_CALLS === "true",
  GET_BLOCK_STATS:
    isDebugLevel3 || process.env.LLAMA_SDK_GET_BLOCK_STATS === "true",
  // GET_LOGS_ERRORS:  isDebugLevel3 || process.env.LLAMA_SDK_GET_LOGS_ERRORS === 'true',
  GET_LOGS_DEBUG:
    isDebugLevel3 || process.env.LLAMA_SDK_GET_LOGS_DEBUG === "true",
  GET_LOGS_INDEXER:
    isDebugLevel3 || process.env.LLAMA_SDK_GET_LOGS_INDEXER === "true",
  DEFAULT_SHORTEN_STRING_LENGTH:
    process.env.LLAMA_SDK_DEFAULT_SHORTEN_STRING_LENGTH ?? "120",
} as {
...
export function getBoolEnvValue(
  key: string,
