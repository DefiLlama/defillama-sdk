...
export const providers = {
  ...
  avax: createProvider("avax", "https://rpc.ankr.com/avalanche,https://api.avax.network/ext/bc/C/rpc", 43114),
  ...
  shiden: createProvider("shiden", "https://shiden.api.onfinality.io/public,https://rpc.shiden.astar.network:8545", 336),
