...
export const providers = {
  ...
  shiden: createProvider(
    "shiden",
    "https://evm.shiden.astar.network,https://shiden.api.onfinality.io/public,https://rpc.shiden.astar.network:8545",
    336
  ),
  palm: createProvider(
    "palm",
  ...
  cronos: createProvider(
    "cronos",
    "https://rpc.vvs.finance,https://evm-cronos.crypto.org,https://evm.cronos.org",
    25
  ),
  ...
  bittorrent: createProvider(
    "bittorrent",
    "https://rpc.bittorrentchain.io",
    199
  ),
  findora: createProvider(
    "findora",
    "https://prod-mainnet.prod.findora.org:8545",
    2152
  ),
  candle: createProvider(
    "candle",
    "https://network.cndlchain.com/,https://rpc.cndlchain.com",
    534
  ),
  ...
  echelon: createProvider(
    "echelon",
    "https://rpc.ech.network,https://evm.ech.network,https://draco.ech.network",
    3000
  ),
  multivac: createProvider(
    "multivac",
    "https://rpc.mtv.ac,https://rpc-eu.mtv.ac",
    62621
  ),
