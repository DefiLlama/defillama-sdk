...
export const providers = {
  ...
  shiden: createProvider(
    "shiden",
    "https://shiden.api.onfinality.io/public,https://rpc.shiden.astar.network:8545",
    336
  ),
  palm: createProvider(
    "palm",
  ...
  cronos: createProvider(
    "cronos",
    "https://evm-cronos.crypto.org,https://cronos-rpc.heavenswail.one,https://cronosrpc-1.xstaking.sg,https://evm.cronos.org",
    25
  ),
