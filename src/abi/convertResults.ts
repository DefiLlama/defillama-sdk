...
export default function (
  results: ethers.Result,
  {
    functionABI,
    chain,
  }: { functionABI?: ethers.FunctionFragment; chain?: string } = {},
) {
  let response: any;
...
function setComponentDetails(
  ...
  if (componentDefinition.type === "tuple") return setDetails(component, chain);
...
function setNameAndTranformAddress({
  response,
  componentDefinition,
  chain,
  index,
