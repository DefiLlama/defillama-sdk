...
test("tuples within tuples", async () => {
  ...
  await api.call({
    abi: getPortfoliosABI,
    target: "0x2080A319A4B11D097050722b6b65d09F754EdC83",
  });
  await kavaApi.call({
    abi: getPortfoliosABI,
    target: "0x49399653f651A25924b3D8718276b5b4372577b1",
  });
});
