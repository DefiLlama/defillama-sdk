...
test("ChainApi - getGasTokenBalance", async () => {
	...
	const res = await api.getGasTokenBalance(
		"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
	);
...
test("ChainApi - getGasTokenBalances", async () => {
	...
	const res = await api.getGasTokenBalances({
		owners: [
			"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
			"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
			"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
	...
	const resNoDup = await api.getGasTokenBalances({
		owners: [
			"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
			"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
			"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
...
test("ChainApi - getEthBalance", async () => {
	...
	const res = await api.getEthBalance(
		"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
	);
...
test("ChainApi - getEthBalances", async () => {
	...
	const res = await api.getEthBalances({
		owners: [
			"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
			"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
			"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
	...
	const resNoDup = await api.getEthBalances({
		owners: [
			"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
			"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
			"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
...
test("ChainApi - getERC20TokenBalances - fail ", async () => {
	...
	const badOwnerAddress = () =>
		api.getERC20TokenBalances({
			tokensAndOwners: [
				[
					"0x419B8ED155180A8c9C64145e76DaD49c0A4Efb97",
					"0x9a849A108764a5cE2Ab4CD3208071B304aAc99A",
				],
			],
		});
	const badTokenAddress = () =>
		api.getERC20TokenBalances({
			tokensAndOwners: [
				[
					"0x419B8ED155180A8c9C64145e76DaD49c0A4Efb90",
					"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
				],
			],
		});
...
test("ChainApi - getGasTokenBalance - fail", async () => {
	...
	const badAddress = () =>
		api.getGasTokenBalance("0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99Adummy");
...
test("ChainApi - getGasTokenBalance - permit failure", async () => {
	...
	const res = await api.getGasTokenBalance(
		"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99Adummy",
		{ permitFailure: true },
	);
...
test("ChainApi - getGasTokenBalances - fail", async () => {
	...
	const oneBadAddress = () =>
		api.getGasTokenBalances({
			owners: [
				"dummy0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
				"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
				"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
				"0x9a849A108764a5cE2Ab4CD3208071B304a9Ac99A",
			],
